...
_A more comprehensive car dealership app.  Written in php, with added Silex and Twig._

## Setup/Installation Requirements

* Clone this repository from [gitHub](https://github.com/MBAllely/car-dealership)
